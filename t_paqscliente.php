...
$crud=new CrudPaq();
$paqs= new Paq();
$listapaqs=$crud->mostrarpaqs($_GET['id_cliente']);
$id=$_GET['id_cliente'];
...
<div class="filtros">
<?php
  $query = $mysqli -> query ("SELECT * FROM cliente WHERE id_cliente= $id");
...
?>
  <label> Paquetes de <b><?php echo $nombre?> </b> </label>
<a href="n_paq.php?id_cliente=<?php echo $id?>"><button class="btn">Recargar</button></a>
</div>
  <table id="myTable">
